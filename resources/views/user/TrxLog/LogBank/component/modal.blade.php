        ...
        <div class="card">
          <div class="card-header">
            <ul class="nav nav-tabs card-header-tabs" id="list-detail" role="tablist">
              <li class="nav-item">
                <a class="nav-link" id="request-tab" href="#request" role="tab" aria-controls="request" aria-selected="true">Request Data</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" id="response-tab" href="#response" role="tab" aria-controls="response" aria-selected="false">Response Data</a>
              </li>
            </ul>
          </div>
          <div class="card-body">
            <div class="tab-content mt-3">
              <div class="tab-pane" id="request" role="tabpanel">
                ...
                <button class="btn btn-icon btn-sm float-right close-detail" onclick="closeDetailData(this)" style="display: none">
