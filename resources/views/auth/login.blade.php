...
@section('content')
    ...
    <div class="col-md-8 col-lg-6 col-xl-5 mx-auto my-10p" id="login">
        <div class="text-center" style="margin-top: -100px;">
            <img src="{{ url('assets/img/vanguard-logo.png') }}" alt="{{ setting('app_name') }}" height="250">
        </div>
                ...
                <div class="p-4">
                    ...
                    <form role="form" action="<?= url('login') ?>" method="POST" id="login-form" autocomplete="off"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="username" id="username" class="form-control input-solid"
                                placeholder="@lang('Email or Username')" value="{{ old('username') }}">
                        </div>
